...
public class MeetingTwoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.results_recycler_view_two);
        listData = new ArrayList<>();
        myAdapter = new MeetingTwoFragment.MyAdapter(listData);
        ...
        firebaseFirestore.collection(session).whereEqualTo("meeting", "2").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
        ...
        @NonNull
        @Override
        public MeetingTwoFragment.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
